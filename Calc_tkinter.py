...
ventana = tk.Tk() #genera la ventana principal
ventana.title("Escape de Coordenadas - Rod Escobar")

# Genera, segun sintaxis de Tkinter, campos para entrada de texto con etiquetas y ubica todo en la ventana.
